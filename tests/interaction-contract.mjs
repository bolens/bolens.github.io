...
try {
  ...
  if (JSON.stringify(glyphSemantics) !== JSON.stringify({ open:true, title:'Glyph explorer', description:'glyph-explorer-help', items:47, uniqueNames:47, decorative:true, named:true, overlay:true, focused:true, closeMotion:0 }) || glyphOverflow > 0) throw new Error(`glyph explorer semantics failed: ${JSON.stringify(glyphExplorer.result.value)}`);
