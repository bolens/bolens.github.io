...
test("every reusable landscape symbol publishes stable named regions", () => {
  assert.equal(symbols.length, 70, "expected the complete reusable 404 asset library");
...
test("named editing regions resolve to unique elements in migrated glyphs", () => {
  for (const id of ["evergreen-shrub", "berry-shrub", "fern-spray", "wildflower-clump", "reed-clump", "camp-tent-shell", "alpine-boulder", "trail-camera", "toasted-marshmallow", "camp-snack-plate", "fire-ring-stone"]) {
