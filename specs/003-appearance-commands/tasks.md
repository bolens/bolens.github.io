# Tasks: Appearance, overlays, and commands
...
**Independent acceptance**: Given an existing preference, when the visitor changes or resets appearance with keyboard or pointer, then controls and rendered appearance agree and focus remains usable.

- [x] T003 [US1] Map US1 requirements to named evidence in `plan.md` without claiming unperformed checks.

## Phase 4: US2

**Independent acceptance**: Given a focused control, when the visitor opens search, selects an available result, and closes the dialog, then the intended command runs and focus returns without leaving a second overlay active.
