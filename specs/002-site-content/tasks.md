# Tasks: Site content and generation
...
**Independent acceptance**: Given a listed project, when a visitor opens its work entry, command result, or case-study link, then the name and destination agree with the maintained project record.

- [x] T003 [US1] Map US1 requirements to named evidence in `plan.md` without claiming unperformed checks.

## Phase 4: US2

**Independent acceptance**: Given valid changed project or palette data, when the maintainer regenerates the site twice, then dependent outputs update once and authored content outside generated regions remains unchanged.
