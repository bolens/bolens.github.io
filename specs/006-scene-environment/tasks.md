# Tasks: 404 conditions, time, and lighting
...
**Independent acceptance**: Given a theme-based condition, when an explicit condition or time is selected and the appearance changes, then the explicit scene choice remains until released.

- [x] T003 [US1] Map US1 requirements to named evidence in `plan.md` without claiming unperformed checks.

## Phase 4: US2

**Independent acceptance**: Given a dry daytime scene, when rain, snow, wind, or night is selected, then materials and atmosphere change without changing the identity of the campsite.
